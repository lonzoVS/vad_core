...
{
    public class SpectreLogVisualization : Visualization
    {
        public SpectreLogVisualization(double[] dspSet)
        {
            this.dspSet = dspSet;
        }
        ...
        {
            samples = dsp.LogSpec(dsp.Spec(samples, Enumerable.Repeat(0.0, fftLenght).ToArray(), fftLenght));
            return samples;
        }
